...
resultado = numero_1 - numero_2
print("A subtração do numero 1 pelo o numero 2 é: ",resultado)

resultado = numero_1 * numero_2
print("A multiplicação do numero 1 pelo o numero 2 é:",resultado)

resultado = numero_1 / numero_2
print("A divisão do numero 1 pelo numero 2 é:",resultado)

resultado = numero_1 ** numero_2
print("O numero 1 elevado pelo numero 2 é",resultado)

resultado = numero_1 // numero_2
print("A divisão inteira do numero 1 pelo numero 2 é",resultado)

resultado = numero_1 % numero_2
print("O resto de divisão do numero 1 pelo numero 2 é",resultado)
